...
const paymentSchema = new mongoose.Schema({
  ...
  timestamps: true,
  collection: 'pickleball_payments'
});
...
const PickleballPayment = mongoose.model('PickleballPayment', paymentSchema);
export default PickleballPayment;
