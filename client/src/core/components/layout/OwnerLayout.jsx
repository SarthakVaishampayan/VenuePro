...
export default function OwnerLayout() {
  ...
  const navItems = [
    ...
    { path: '/owner/sessions', label: 'Sessions', icon: Clock },
    { path: '/owner/resources', label: labels.resourcePlural, icon: Table2 },
    { path: '/owner/customers', label: labels.customerPlural, icon: Users },
    { path: '/owner/payments', label: 'Payments', icon: DollarSign },
    { path: '/owner/dues', label: 'Dues', icon: Wallet },
    { path: '/owner/expenses', label: 'Expenses', icon: Receipt },
      ...
      <aside className={clsx(
        ...
        <div className="flex items-center gap-3 px-6 h-16 border-b border-white/10 flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-sidebar-text text-xs opacity-60 truncate max-w-[160px]">{labels.businessTypeName} · Owner</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 flex-shrink-0 bg-surface border-b border-border flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Notifications */}
            <NotificationBell role="owner" notificationsPath="/owner/notifications" />
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-1 z-20 w-56 bg-surface rounded-xl shadow-lg border border-border animate-scaleIn overflow-hidden">
                    ...
                    <div className="p-1">
                      ...
                      <button
                        onClick={() => { setProfileOpen(false); navigate('/owner/change-password'); }}
                        className="w-full flex items-center gap-2 px-3 py-2 text-sm text-text-primary rounded-lg hover:bg-surface-tertiary transition-colors"
                      >
